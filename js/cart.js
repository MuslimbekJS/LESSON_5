      ...
      <div class="card">
        ...
        <div class="card-content">
          ...
          <div class="flex gap-3 py-2">
            <button class="btn btn-sm btn-outline-dark" onclick="decrement(${product.id})">-</button>
              ${product.numOfProduct}
            <button class="btn btn-sm btn-outline-dark" onclick="increment(${product.id})">+</button>
          </div>
          <div class="flex gap-3 py-2">
